...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: QaipWgLIw8/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: _R8iMQS-_G/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg___7FL9O)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg__gtR6P)}
                role={"img"}
              />
            ),
